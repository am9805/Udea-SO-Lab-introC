...
int procentajeAciertos(int aciertos, int fallos);
...
int main()
{
  ...
  int porcentaje = procentajeAciertos(contadorAciertos, contadorDesaciertos);
  if(porcentaje < 75 ){
...
int procentajeAciertos(int aciertos, int fallos)
{
  ...
  resultado = (aciertos * 100 )/ total;
  printf("El porcentaje de aciertos respecto al total de preguntas es: %d%% \n", resultado);
  return resultado;
}
